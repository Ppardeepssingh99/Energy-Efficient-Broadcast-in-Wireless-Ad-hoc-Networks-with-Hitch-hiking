...
set f [open Aodv300m.25n.500mob.tr w]
$ns trace-all $f
set namtrace [open Aodv300m.25n.500mob.nam w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)
set f0 [open packets_received_Aodv300m.25n.500mob.tr w]
set f1 [open packets_lost_Aodv300m.25n.500mob.tr w]
...
proc finish {} {
  ...
  exec xgraph packets_received_Aodv300m.25n.500mob.tr packets_lost_Aodv300m.25n.500mob.tr 
        exec nam -r  5m Aodv300m.25n.500mob.nam &
	exit 0
}
