...
set f [open Aodv300m.25n.100mob.tr w]
$ns trace-all $f
set namtrace [open Aodv300m.25n.100mob.nam w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)
set f0 [open packets_received_Aodv300m.25n.100mob.tr w]
set f1 [open packets_lost_Aodv300m.25n.100mob.tr w]
...
proc finish {} {
  ...
  exec xgraph packets_received_Aodv300m.25n.100mob.tr packets_lost_Aodv300m.25n.100mob.tr 
        exec nam -r  5m Aodv300m.25n.100mob.nam &
	exit 0
}
...
$ns at 2.0 "$n(5) setdest 502.0 400.0 100.0"
